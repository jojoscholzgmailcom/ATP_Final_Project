...
to setup-hyperparams
  set initial-people 200
  set average-recovery-chance 100
  set infection-chance 80
  set average-recovery-time 9
  set immunity-divisor 1.1
  set average-infection-threshold 31
  set cured-immunity-bonus 81
  set are-isolating? true
  set vaccines? true
  set vaccination-window-frequency 10
  set mask-infection-chance-reduction 61
  set infection-radius 2.7
  set DoPeopleDie? true
end
...
to init-person
  set vaccinated 0
    ...
    set infection-threshold random-normal average-infection-threshold 5

    set temp-infection-threshold 0

    if infection-threshold < 0 [
      set infection-threshold 0
    ]

    if recovery-chance < 0 [
      set recovery-chance 0
    ]
...
;; Green is a person with resistance, with darker greens indicating a higher resistance
...
to reduce-temp-resistance
  set temp-infection-threshold temp-infection-threshold / immunity-divisor
end
...
<experiments>
  <experiment name="experiment" repetitions="10" runMetricsEveryStep="true">
    ...
    <metric>r0</metric>
    <steppedValueSet variable="isolation-chance" first="0" step="10" last="100"/>
    <steppedValueSet variable="vaccination-start" first="0" step="30" last="210"/>
    <steppedValueSet variable="wearing-mask-chance" first="0" step="10" last="100"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
